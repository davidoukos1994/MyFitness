...
const starterPrograms=[
 {id:'fullbody-dumbbells-beginner',title:'Ολόκληρο σώμα με βαράκια — Αρχάριος',place:'home',level:'beginner',duration:40,goal:'general',exercises:[['Καθίσματα κρατώντας βαράκι στο στήθος',3,10],['Πιέσεις στήθους με βαράκια στο πάτωμα',3,10],['Κωπηλατική με ένα βαράκι',3,10],['Άρσεις θανάτου με βαράκια και τεντωμένα πόδια',3,10],['Σανίδα',3,30]]},
 {id:'bodyweight-20',title:'Ασκήσεις με το βάρος του σώματος — 20 λεπτά',place:'home',level:'beginner',duration:20,goal:'fatloss',exercises:[['Καθίσματα',3,12],['Κάμψεις',3,8],['Προβολές ποδιών',3,10],['Γέφυρες γλουτών',3,15],['Ορειβάτες',4,30]]},
 {id:'upper-dumbbells',title:'Άνω σώμα με βαράκια',place:'home',level:'intermediate',duration:45,goal:'muscle',exercises:[['Πιέσεις στήθους με βαράκια',4,10],['Κωπηλατική σκυφτός με βαράκια',4,10],['Πιέσεις ώμων με βαράκια',3,10],['Πλάγιες άρσεις ώμων με βαράκια',3,12],['Κάμψεις δικεφάλων με βαράκια',3,12],['Εκτάσεις τρικεφάλων πάνω από το κεφάλι',3,12]]},
 {id:'lower-dumbbells',title:'Πόδια και γλουτοί με βαράκια',place:'home',level:'intermediate',duration:45,goal:'strength',exercises:[['Καθίσματα κρατώντας βαράκια',4,10],['Προβολές με βαράκια',3,10],['Άρσεις θανάτου με βαράκια',4,10],['Ανεβάσματα σε σκαλοπάτι με βαράκια',3,10],['Γέφυρες γλουτών με βαράκι',3,15],['Άρσεις γάμπας κρατώντας βαράκια',4,15]]},
 {id:'fullbody-strength',title:'Δύναμη ολόκληρου σώματος με βαράκια',place:'home',level:'intermediate',duration:50,goal:'strength',exercises:[['Καθίσματα με βαράκια',4,8],['Πιέσεις στήθους με βαράκια',4,8],['Κωπηλατική με βαράκια',4,8],['Πιέσεις ώμων με βαράκια',3,8],['Άρσεις θανάτου με βαράκια',4,8],['Σανίδα με άγγιγμα ώμων',3,20]]},
 {id:'bodyweight-full',title:'Ολόκληρο σώμα χωρίς εξοπλισμό',place:'home',level:'beginner',duration:35,goal:'general',exercises:[['Καθίσματα',4,12],['Κάμψεις σε τοίχο ή γόνατα',3,10],['Προβολές προς τα πίσω',3,10],['Βυθίσεις τρικεφάλων σε καρέκλα',3,8],['Γέφυρες γλουτών',3,15],['Σανίδα',3,30]]},
 {id:'core-bodyweight',title:'Κοιλιακοί και κορμός με βάρος σώματος',place:'home',level:'beginner',duration:25,goal:'general',exercises:[['Σανίδα',3,30],['Πλάγια σανίδα',3,20],['Άρσεις αντίθετου χεριού και ποδιού',3,10],['Νεκρό έντομο',3,10],['Ορειβάτες',3,30],['Άρσεις λεκάνης',3,15]]},
 {id:'conditioning-dumbbells',title:'Κυκλική προπόνηση με βαράκια',place:'home',level:'intermediate',duration:30,goal:'endurance',exercises:[['Καθίσματα και πίεση ώμων με βαράκια',4,10],['Κωπηλατική με βαράκια',4,10],['Προβολές εναλλάξ',4,10],['Κάμψεις',4,8],['Άρσεις θανάτου με βαράκια',4,10],['Ορειβάτες',4,30]]},
 {id:'mobility',title:'Κινητικότητα και αποκατάσταση',place:'home',level:'beginner',duration:25,goal:'mobility',exercises:[['Κίνηση γάτας και αγελάδας',2,10],['Περιστροφές ισχίων 90/90',2,8],['Περιστροφές θωρακικής μοίρας',2,8],['Διάταση καμπτήρων ισχίου',2,40],['Στάση του παιδιού',2,45]]},
 {id:'superset-fullbody-1',title:'Superset ολόκληρου σώματος με βαράκια',place:'gym',level:'intermediate',duration:35,goal:'general',exercises:[['Καθίσματα με βαράκια + Πιέσεις ώμων',4,10],['Κωπηλατική με βαράκια + Κάμψεις',4,10],['Άρσεις θανάτου με βαράκια + Ορειβάτες',4,10],['Προβολές με βαράκια + Σανίδα',3,10]]},
 {id:'superset-upper-1',title:'Superset άνω σώματος',place:'gym',level:'intermediate',duration:35,goal:'muscle',exercises:[['Πιέσεις στήθους με βαράκια + Κωπηλατική με βαράκια',4,10],['Πιέσεις ώμων + Πλάγιες άρσεις ώμων',3,10],['Κάμψεις δικεφάλων + Εκτάσεις τρικεφάλων',3,12],['Κάμψεις + Σανίδα με άγγιγμα ώμων',3,10]]},
 {id:'superset-lower-1',title:'Superset ποδιών και γλουτών',place:'gym',level:'intermediate',duration:35,goal:'strength',exercises:[['Καθίσματα με βαράκια + Άρσεις θανάτου με βαράκια',4,10],['Προβολές προς τα πίσω + Γέφυρες γλουτών',3,12],['Ανεβάσματα σε σκαλοπάτι + Άρσεις γάμπας',3,12],['Καθίσματα χωρίς βάρος + Σανίδα',3,15]]}
];
...
function addSimpleWorkout(date=selectedDate){
 openModal(`<h2>Καταχώριση προπόνησης</h2><p class="muted">${fmtDate(date)}</p><p>Μπορείς να καταχωρίσεις μόνο ότι έκανες προπόνηση. Οι ασκήσεις και η διάρκεια προστίθενται προαιρετικά αργότερα.</p><label>Τίτλος (προαιρετικό)<input id="simpleWorkoutTitle" placeholder="Προπόνηση"></label><div class="modal-actions"><button value="cancel" class="secondary">Ακύρωση</button><button type="button" class="primary" id="confirmSimpleWorkout">Καταχώριση προπόνησης</button></div>`);
 $('#confirmSimpleWorkout').onclick=()=>{const per=person();per.calendar[date]=per.calendar[date]||[];per.calendar[date].push({id:uid(),title:$('#simpleWorkoutTitle').value.trim()||'Προπόνηση',done:true,duration:0,exercises:[],completedAt:new Date().toISOString()});closeModal();save();renderCalendar();toast('Η προπόνηση καταχωρίστηκε')};
}
